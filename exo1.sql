...
<p>CREATE DATABASE IF NOT EXISTS 'frameworks' CHARACTER SET 'utf8';</p>
<p>CREATE DATABASE IF NOT EXISTS 'languages' CHARACTER SET 'utf8';</p>
<p>DROP DATABASE 'languages';</p>
<p>DROP DATABASE IF EXISTS 'frameworks';</p>
<p>DROP DATABASE IF EXISTS 'languages';</p>

<h1>Partie2</h1>
<p>CREATE DATABASE codex;</p>
...
<p>ATLTER TABLE 'framework' ADD 'versions' INT ;</p>
...
WHERE id IN ('3','5','7');</p>
<p>SELECT*
FROM 'languages' WHERE 'languages'='Javascript' LIMIT 2;</p>
...
<p>SELECT languages.name , COUNT(frameworks.name) FROM languages LEFT JOIN frameworks ON languages.id = frameworks.languagesID GROUP BY languages.name</p>
